...
export default function FacultyDashboard() {
  ...
  return (
    <div ref={containerRef} className="max-w-6xl mx-auto space-y-6 pb-12">
      {/* Header Banner */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-neutral-900 via-neutral-950 to-[#A51C30]/20 p-6 rounded-2xl border border-white/10 backdrop-blur-xl">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-600/20 text-red-400 border border-red-500/30 text-xs font-semibold uppercase tracking-wider mb-2">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Button
            ...
            className="bg-neutral-800 hover:bg-neutral-700 text-white text-xs px-3.5 py-2 rounded-xl flex items-center gap-1.5 border border-white/10"
          >
            <Plus className="w-3.5 h-3.5 text-emerald-400" /> Add Subject
          </Button>
          <Button
            onClick={() => setUploadNoteModalOpen(true)}
            className="bg-[#A51C30] hover:bg-[#851626] text-white text-xs px-3.5 py-2 rounded-xl flex items-center gap-1.5 shadow-md shadow-red-950/50"
          >
      ...
      <Card className="dashboard-card bg-neutral-900/60 border-white/10">
        <div className="flex items-center justify-between mb-4">
          ...
          <Button
            size="sm"
            onClick={() => setAddCourseModalOpen(true)}
            className="bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-300 border border-indigo-500/30 text-xs px-3 py-1.5 rounded-xl flex items-center gap-1.5"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {courses.slice(0, 6).map((c) => (
            <div
              key={c.id}
              className="p-3.5 rounded-xl bg-black/40 border border-white/5 hover:border-white/15 transition-all flex flex-col justify-between"
            >
              <div>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <Button
              size="sm"
              onClick={() => setUploadNoteModalOpen(true)}
              className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs px-3 py-1.5 rounded-xl flex items-center gap-1.5 shadow-md shadow-emerald-950/50"
            >
              <UploadCloud className="w-3.5 h-3.5" /> Upload Class Note
            </Button>
            <Button
              ...
              variant="outline"
              onClick={() => router.push("/faculty/classroom")}
              className="border-white/10 text-neutral-300 hover:text-white text-xs px-3 py-1.5 rounded-xl"
            >
              Open Full Classroom
            </Button>
          </div>
        ...
        {materials.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {materials.slice(0, 4).map((m) => (
              <div
                key={m.id}
                className="p-3.5 rounded-xl bg-black/40 border border-white/5 hover:border-white/15 transition-all flex items-start justify-between gap-3"
              >
      ...
      <Card className="dashboard-card bg-neutral-900/60 border-white/10">
        <div className="flex items-center justify-between mb-4">
          ...
          <Button
            ...
            className="bg-amber-600/20 hover:bg-amber-600/30 text-amber-300 border border-amber-500/30 text-xs px-3 py-1.5 rounded-xl flex items-center gap-1.5"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {vacantRooms.slice(0, 4).map((vr) => (
            <div
              key={vr.room.id}
              className="p-3.5 rounded-xl bg-black/40 border border-white/5 hover:border-emerald-500/30 transition-all flex flex-col justify-between"
            >
              <div>
      ...
      {previewMaterial && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-md p-4 animate-in fade-in">
          <div className="bg-neutral-950 border border-white/15 rounded-2xl max-w-3xl w-full p-6 space-y-4 shadow-2xl flex flex-col max-h-[90vh]">
            <div className="flex items-center justify-between pb-3 border-b border-white/10">
              <div className="flex items-center gap-2">
