...
const navItems = [
  ...
  { href: "/admin/digital-twin", label: "Digital Twin", icon: Box },
  { href: "/admin/control-center", label: "Campus Control", icon: Gauge },
  { href: "/admin/tour", label: "360 Campus Tour", icon: Map },
  { href: "/admin/analytics", label: "Analytics", icon: BarChart3 },
  { href: "/admin/simulation", label: "Simulation", icon: Play },
    ...
    <>
      ...
      >
        <div className="flex flex-col flex-1 min-h-0">
          ...
          <nav className="flex-1 overflow-y-auto overflow-x-hidden py-4 space-y-1 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent hover:scrollbar-thumb-white/20">
            {navItems.map((item) => {
